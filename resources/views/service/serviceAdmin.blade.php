                            ...
                            <div class="row g-0">
                                <div class="col-12 col-lg-5 col-xl-3 border-right">
                                    @foreach ($users as $user)
                                        <a href="{{ route('service/admin', $user['id']) }}" class="list-group-item list-group-item-action border-0">
                                    ...
                                    @if ($id)
                                        <div class="py-2 px-4 border-bottom d-none d-lg-block">
                                            <div class="d-flex align-items-center py-1">
                                                <div class="position-relative"><img src="https://ui-avatars.com/api/?name={{ $otherUser->name }}" alt="{{ $otherUser->name }}" class="rounded-circle mr-1" width="40" height="40" /></div>
